...
var dot, dotParsing, dotProcessingArguments, fs, processFile, processFileModule, processGeneralConfig, processModule, _beginStackFile, _beginStackPartial, _endStack, _endStackPartial;
...
_beginStackFile = function(fileid) {
  return "{{;it = it || {};var _stack = ['" + fileid + "'];var self = it['" + fileid + "'] || {};}}";
};

_beginStackPartial = function(fileid) {
  return "{{;_stack.push('" + fileid + "');self = it['" + fileid + "'] || {};}}";
};
...
module.exports = {
  ...
  oncall: function(obj, params, cb) {
    ...
    this.getLogger().info("Processing file " + (obj.getId()));
